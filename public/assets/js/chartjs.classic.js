      ...
      scales: {
        yAxes: [{
          ...
          gridLines: {
            color: "rgba(0, 37, 78, 0.1)",
            zeroLineWidth: 1,
            zeroLineColor: "rgba(0, 37, 78, 0.1)",
            drawBorder: false,
            tickMarkLength: 0
          }
        }],
...
if ($.exists("#tb-chart3-type2")) {
  ...
  var myChart3 = new Chart(ctx3, {
    ...
    data: {
      labels: ["Opened", "Sent"],
      datasets: [{
        backgroundColor: ["#5856d6", "rgba(0, 37, 78, 0.1)"],
        hoverBackgroundColor: ["#5856d6", "rgba(0, 37, 78, 0.1)"],
        data: [70, 30],
        borderWidth: 0,
        hoverBorderColor: ["#5856d6", "rgba(0, 37, 78, 0.1)"],
        hoverBorderWidth: 3
      }]
    },
    options: {
...
if ($.exists("#tb-chart3-type3")) {
  ...
  var myChart3 = new Chart(ctx3, {
    ...
    data: {
      labels: ["Opened", "Sent"],
      datasets: [{
        backgroundColor: ["#007aff", "rgba(0, 37, 78, 0.1)"],
        hoverBackgroundColor: ["#007aff", "rgba(0, 37, 78, 0.1)"],
        data: [70, 30],
        borderWidth: 0,
        hoverBorderColor: ["#007aff", "rgba(0, 37, 78, 0.1)"],
        hoverBorderWidth: 3
      }]
    },
    options: {
