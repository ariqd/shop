...
class SalesOnlineController extends Controller
{
    public function create()
    {
        ...
        return view('sales-online.form', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($purchase) {
            ...
            return redirect()->back()->with('info', 'Nota penjualan online berhasil ditambahkan!');
        } else {
            return redirect()->back()->with('error', 'Nota penjualan online gagal ditambahkan!');
        }
    }
